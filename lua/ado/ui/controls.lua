  ...
  return {
    {
      ...
      bindings = {
        ...
        { key = 'd', action = 'Toggle list-only (full-width Title/Description)' },
    ...
    },
    {
      ...
      bindings = {
        ...
        { key = '<Tab>', action = 'Cycle Details / History / Comments' },
        { key = 'c', action = 'Add a comment (<C-s> post, q cancel)' },
        { key = 'd', action = 'Hide detail (list-only full-width list)' },
        { key = 'H', action = 'Shrink list pane width' },
        { key = 'L', action = 'Grow list pane width' },
      },
    },
